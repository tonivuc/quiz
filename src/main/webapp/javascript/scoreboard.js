...
function addSpillere(startIndeks) {
    ...
    for (i=startIndeks; i < spillere.length; i++) {
        ...
        var markup = "<li class='list-group-item justify-contentbetween'>"+spillere[i].kallenavn.replace(/"/g, '')+"<span class='badge badge-default badge-pill' id="+i+">"+spillere[i].poeng+"</span></li>";
